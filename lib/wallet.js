...
Wallet.prototype.unlock = function(privateKey) {
  this.account.owner.privateKey = privateKey;
  this.account.active.privateKey = privateKey;
  this.account.signatureProvider = new JsSignatureProvider([privateKey]);
  this.isLocked = false;
};
...
Wallet.prototype.dumpKeys = function() {
  ...
  return {
    public: this.account.owner.publicKey,
    private: this.account.owner.privateKey
  };
};
